...
proto = {
    ...
    'monster_gixian_ravager': {
        ...
        'attack_speed': 1.2,
        'ai': ai.AI_Default,
        'description': 'A horrible fusion of metal and burnt flesh. Smoke pours from a gaping steel maw.',
        ...
        'death_function' : {
            ...
            'duration': None,
            'require_tile': 'lava',
            'message': 'The gixian melts into shambling iron!',
        },
        'equipment': [{'weapon_warhammer': 1, 'weapon_greatsword': 1, 'weapon_halberd': 1, 'weapon_scythe': 1}],
        'loot_level': 1
    },

    'monster_living_furnace': {
        'name': 'Living Furnace',
        'char': 'F',
        'color': libtcod.flame,
        'hp': 65,
        ...
        'attack_speed': 1.2,
        'ai': ai.AI_Default,
        'description': 'A horrible fusion of metal and burnt flesh formed around a magical furnace.',
        'resistances': {'fire' : 2, 'burning': 'immune'},
        'shred': 1,
        'flags' : EVIL,
        'subtype' : 'humanoid',
        'attributes': ['ability_flame_breath'],
        'death_function' : {
            'function': 'on_death_summon',
            'monster': 'monster_shambling_iron',
            'duration': None,
        ...
        'equipment': [{'weapon_crossbow': 1, 'weapon_longbow': 1}],
        'loot_level': 1
    },
    ...
    'monster_shambling_iron': {
        ...
        'attack_speed': 0.5,
        'ai': ai.AI_Default,
        'description': 'A twisted undead made of melted iron',
        'resistances': {'fire' : 'immune', 'burning': 'immune'},
        'attributes': ['ability_lava_bile'],
        'shred': 1,
        'flags' : EVIL,
        'subtype' : 'undead',
        'movement_type' : pathfinding.NORMAL | pathfinding.LAVA
    },

    'monster_gixian_archon': {
        'name': 'Gixian Archon',
        'char': 'A',
        'color': libtcod.flame,
        'hp': 300,
        ...
        'attack_speed': 1.2,
        'ai': ai.AI_Default,
        'description': 'A mighty fusion of metal and burnt flesh, constructed from the bodies of lesser gixians.',
        'resistances': {'fire' : 'immune', 'burning': 'immune', 'stun': 2},
        'shred': 1,
        'flags' : EVIL,
        'subtype' : 'humanoid',
        'attributes': ['ability_hex', 'ability_fireball', 'ability_thermal_instability'],
        'equipment': [{'weapon_warhammer': 1, 'weapon_greatsword': 1, 'weapon_halberd': 1, 'weapon_scythe': 1},
                      {'equipment_mail_armor': 40, 'equipment_brigandine': 50, 'equipment_plate_armor': 10},
                      {'none': 60, 'equipment_iron_helm': 20, 'equipment_great_helm': 20}],
        'loot_level': 2,
