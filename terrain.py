...
data = {
    ...
    'gnarled tree': TileData(True, True, 'gnarled tree', chr(157), (94, 75, 47), (31, 31, 31),
                             'a twisted, leafless tree, worn down by the gritty badland winds', flammable=True, isWall=True),
    ...
    'mud': TileData(False, False, 'mud', 247, (94, 75, 47), (63, 50, 31),
                             'a thick puddle of mud that impedes movement', consts.MUD_COST, isWater=True),
    ...
    'dry grass': TileData(False, False, 'dry grass', ',', (56, 49, 43), (38, 33, 29),
                             'dry stalks of grass that rustle in the wind', flammable=True, isFloor=True),
